#!/bin/bash
#SBATCH --job-name=dsgen_m2
#SBATCH --output=/home/anshulk/ds-gen-10701/logs/dsgen_m2-%j.out
#SBATCH --error=/home/anshulk/ds-gen-10701/logs/dsgen_m2-%j.err
...
echo "============================================================"
echo "dsgen — Method 2: Conservative Threshold"
echo "============================================================"
